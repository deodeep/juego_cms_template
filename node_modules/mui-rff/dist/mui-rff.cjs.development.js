...
function ErrorMessage(_ref) {
  ...
  if (showError) {
    return React.createElement(material.FormHelperText, _extends({}, formHelperTextProps), meta.error || meta.submitError);
  } else if (helperText) {
    return React.createElement(material.FormHelperText, _extends({}, formHelperTextProps), helperText);
  } else {
...
function Checkboxes(props) {
  ...
  return React.createElement(material.FormControl, _extends({
    required: required,
    error: isError
  }, formControlProps), label ? React.createElement(material.FormLabel, _extends({}, formLabelProps), label) : React.createElement(React.Fragment, null), React.createElement(material.FormGroup, _extends({}, formGroupProps), itemsData.map(function (item, idx) {
    return React.createElement(material.FormControlLabel, _extends({
      key: idx,
      name: name,
      label: item.label,
      value: single ? undefined : item.value,
      disabled: item.disabled,
      control: React.createElement(reactFinalForm.Field, _extends({
        type: "checkbox",
        name: name,
        render: function render(_ref) {
          ...
          return React.createElement(material.Checkbox, _extends({
            name: name,
            value: value,
            onChange: onChange,
            checked: checked,
    ...
    return React.createElement(material.FormControlLabel, _extends({
      ...
      control: React.createElement(reactFinalForm.Field, _extends({
        ...
        render: function render(_ref) {
          ...
          return React.createElement(material.Switch, _extends({
            name: name,
            value: value,
            onChange: onChange,
            checked: checked,
...
function Radios(props) {
  ...
  return React.createElement(material.FormControl, _extends({
    required: required,
    error: isError
  }, formControlProps), !!label && React.createElement(material.FormLabel, _extends({}, formLabelProps), label), React.createElement(material.RadioGroup, _extends({}, radioGroupProps), data.map(function (item, idx) {
    return React.createElement(material.FormControlLabel, _extends({
      key: idx,
      name: name,
      label: item.label,
      ...
      control: React.createElement(reactFinalForm.Field, _extends({
        ...
        render: function render(_ref) {
          ...
          return React.createElement(material.Radio, _extends({
            name: name,
            value: value,
            onChange: onChange,
            checked: checked,
  ...
  return React.createElement(reactFinalForm.Field, _extends({
    ...
    render: function render(_ref) {
      ...
      return React.createElement(material.FormControl, _extends({
        ...
        fullWidth: true,
        variant: variant
      }, formControlProps), !!label && React.createElement(material.InputLabel, _extends({
        id: labelId
      }, inputLabelProps), label), React.createElement(material.Select, _extends({
        name: name,
        value: finalValue,
        onChange: onChange,
        multiple: multiple,
        ...
        return React.createElement(material.MenuItem, _extends({
          value: item.value,
          key: item.value,
          disabled: item.disabled
...
function DatePickerWrapper(props) {
  ...
  return React.createElement(xDatePickers.DatePicker, _extends({
    onChange: onChange,
...
function DateTimePickerWrapper(props) {
  ...
  return React.createElement(xDatePickers.DateTimePicker, _extends({
    onChange: onChange,
    value: value === '' ? null : value
  }, lessRest, {
    slotProps: {
...
function TimePickerWrapper(props) {
  ...
  return React.createElement(xDatePickers.TimePicker, _extends({
    onChange: onChange,
    value: value === '' ? null : value
  }, lessRest, {
    slotProps: {
